...
- Captcha: La pagina de registro de sesion posee un captcha, el cual se utiliza para verificar si el usuario es humano o bot, lo implementamos, ya que en muchas paginas se posee este tipo de validacion de seguridad al momento de registro o inicio de sesion.
